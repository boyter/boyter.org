...
The last few years have been pretty wild in the software development space. My passion project searchcode.com was deeply affected and as a result I had to [shut it down](https://boyter.org/posts/searchcode-is-being-rebooted/) and figure out what to do with it.

The reality is, in 2026 the average user of your site isn't "Dave" filling in a form and clicking a mouse anymore. [Half the internet is bot traffic](https://www.techradar.com/pro/security/bots-now-account-for-over-half-of-all-internet-traffic) and with LLM's arriving in the tail end of 2022, the human interface to the computer was changed. Forever.

While there is considerable debate about the [best way](https://ejholmes.github.io/2026/02/28/mcp-is-dead-long-live-the-cli.html) to get a LLM to [perform useful](https://kanyilmaz.me/2026/02/23/cli-vs-mcp.html) work, it's hard to argue against the idea that LLM's and their capabilities will continue to expand, performing more and more tasks for humans. A more human interface which is what a LLM offers is very much like System 1.0 on the original Macintosh was to the CLI and is the next logical step for computing interfaces.
...
![token efficeny](/static/searchcode-rebooted/token_saving.png)
...
Now you may notice I have not told you what it actually does. In fact, assuming you are human I don't know if that even matters anymore. If you are a LLM you may want to go and download [https://searchcode.com/llms.txt](https://searchcode.com/llms.txt) and work out if this works for you. If you are human, ask your LLM to do it for you.
