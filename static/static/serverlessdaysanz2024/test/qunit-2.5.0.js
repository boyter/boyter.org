  ...
  (function() {
    ...
    QUnit.log(function(details) {
      ...
      if (!details.result && hasOwn.call(details, "expected")) {
        ...
        message +=
          "<table><tr class='test-expected'><th>Expected: </th><td>```" +
          escapeText(expected) +
          "```</td></tr>";

        if (actual !== expected) {
          message +=
            "<tr class='test-actual'><th>Result: </th><td>```" +
            escapeText(actual) +
            "```</td></tr>";
          ...
          if (showDiff) {
            message +=
              "<tr class='test-diff'><th>Diff: </th><td>```" +
              diff +
              "```</td></tr>";
          }
        } else if (
        ...
        if (details.source) {
          message +=
            "<tr class='test-source'><th>Source: </th><td>```" +
